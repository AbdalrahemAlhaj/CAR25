...
export default class PageTwo extends Component<Props> {
  ...
  checkPageClear = (source) => {
    ...
    console.log("Category Clear " + this.categoryClear + " Textfield Clear " + this.textFieldClear + " Web Clear " + this.webClear + " Date Clear " + this.dateClear + " Check Clear " + this.checkClear + " Select Clear " + this.selectClear + " Static Clear " + this.areStaticFieldsClear);
