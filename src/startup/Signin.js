...
export default class Signin extends Component<Props> {
  ...
  componentDidMount = async () => {
    ...
    GoogleSignin.configure({
      iosClientId: '87246391390-u8g068obpm7nh1qqugldk73h0sgn22e6.apps.googleusercontent.com',
    });
  ...
  render() {
    ...
    return (
      ...
      orderStore.showFacebook ?  <TouchableOpacity
              onPress={() => this.fbsdk()}
...
:null}
          ...
          { 
          !orderStore.showFacebook && ! orderStore.showGoogle ? null
          :
